...
from catalog import put_episode_catalog_item, put_movie_catalog_item, get_tv_series as _get_tv_series, get_tv_series_season_episodes as _get_tv_series_season_episodes, get_tv_series_seasons as _get_tv_series_seasons
...
def lambda_handler(event: dict, _: dict):
    ...
    if type(metadata) == TVEpisodeMetadata:
    ...
    elif type(metadata) == MovieMetadata:
        ...
        raise ValueError("Not sure how to handle the metatype. Supported: TVEpisodeMetadata, MovieMetadata.")
