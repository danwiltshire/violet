...
def get_tv_imagery(
    ...
    logger.info(
        "Matched TV series with TheMovieDB",
        extra={
            "series_id": series_id,
        },
    )
    ...
    episode_stills = (
        tmdb.episode(movie_db_series_id, season_number, episode_number).images().stills
    )
